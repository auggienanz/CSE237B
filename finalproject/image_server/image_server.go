...
func writeImageWithTemplate(w http.ResponseWriter, img *image.Image) {
    ...
    time := fmt.Sprintf("%020d",time.Now().UnixNano())
    var ImageTemplate string = `<!DOCTYPE html><html lang="en"><head></head><body>` + time + `<img src="data:image/jpg;base64,{{.Image}}"></body>`
